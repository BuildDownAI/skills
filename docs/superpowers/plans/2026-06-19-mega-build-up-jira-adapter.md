...
**Goal:** Make `bd-mega-build-up` drive a build-up into Linear *or* Jira by splitting its tracker-touching mechanics into per-tracker adapter docs behind a tracker-neutral core.
