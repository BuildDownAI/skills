...
- Look for a comment matching the bd-smoke-jumper report format (`## 🔥 Bd-Smoke-Jumper Report`)
...
```
## 🔥 Bd-Smoke-Jumper Report — PR #{number}
...
```
# Bd-Smoke-Jumper Session Summary — {date}
