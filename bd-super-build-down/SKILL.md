...
### Bd-Summit-Push Risk Scan (automatic for 5+ PRs)
...
## Phase 3: Bd-Smoke-Jumper Dispatch (Mandatory)
...
**Title:** `Super Bd-Build-Down Summary — {Month Day}: {brief focus}`
...
```markdown
# Super Bd-Build-Down Summary — {date}
